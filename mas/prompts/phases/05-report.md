...
- When evidence is sparse, use this confidence rule: "High confidence only that evidence collection is required; low confidence in specific root causes, impact size, or feature priority until Sprint 0 evidence is collected."
