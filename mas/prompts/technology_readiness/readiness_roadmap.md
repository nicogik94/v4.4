...
- `roadmap_phases` must be an array of objects, not strings. Each object should include trl, phase_name, time_range, objective, evidence_needed, and decision_gate when known.
